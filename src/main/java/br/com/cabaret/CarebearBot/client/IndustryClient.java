...
public interface IndustryClient {
	...
	public List<MiningObserversDetailDto> miningObserversDetail(@PathVariable Long corporation_id, @PathVariable Long observer_id, @RequestHeader("Authorization") String authorizationToken);
}
